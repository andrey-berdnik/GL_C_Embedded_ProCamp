...
#include "support/setup_elevator_logic_cb.h"
...
void test_movin_on_call_from_1_to_2_floor_functional()
{
...
void test_movin_on_call_from_1_to_3_floor_functional()
{
...
void test__movin_on_call_from_1_to_3_pause_3_to_2_floor_functional()
{
